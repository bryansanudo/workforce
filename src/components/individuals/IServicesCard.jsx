            ...
            <div className="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
              ...
              <div className="flex flex-col overflow-hidden shadow-xl">
                <div className="flex flex-col items-center justify-center flex-1 p-6 bg-white lg:py-8 lg:px-7 gap-4">
                  ...
                  <p>
                    The Immigration and Nationality Act, passed in 1990, created
                    the EB-3 Unskilled Visa program.
                  </p>
                </div>
              </div>
              {/* Card two */}
              <div className="flex flex-col overflow-hidden shadow-xl">
                <div className="flex flex-col items-center justify-center flex-1 p-6 bg-white lg:py-8 lg:px-7 gap-4">
                  ...
                  <p>
                    Anyone can participate in this program. There are no
                    educational or skill prerequisites for applying.
                  </p>
                </div>
              </div>
              {/* Card three */}
              <div className="flex flex-col overflow-hidden shadow-xl">
                <div className="flex flex-col items-center justify-center flex-1 p-6 bg-white lg:py-8 lg:px-7 gap-4">
                  ...
                  <p>
                    Applicants can complete this procedure either from within
                    the United States, if they live in the US on a different
                    type of visa, or from their country of origin or where they
                    currently reside.
                  </p>
                </div>
              </div>
