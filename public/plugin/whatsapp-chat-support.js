 ...
 * ====================================================================== */
  ...
  WhatsappChatSupport.DEFAULTS = {
    ...
    timezone: "America/New_York", // When using the date and time from the user browser you can transform it to your current timezone (in case your user is in a different timezone)
